...
ENT.PrintName = "BlueShank's Fumo" -- The name that will appear in the spawn menu.
ENT.Author = "ByakuyaKuchiki" -- The author's name for this Entity.
ENT.Category = "ByakuyaKuchiki's Entities" -- The category for this Entity in the spawn menu.
